...
class ResidualBlockNoBN2x2(nn.Module):
    """Residual block without BN.
    ...
    def __init__(self, mid_channels=64, res_scale=1.0):
        super().__init__()
        self.res_scale = res_scale
        self.conv1 = nn.Conv2d(mid_channels, mid_channels, 1, bias=True)
        self.conv2 = nn.Conv2d(mid_channels, mid_channels, 1, bias=True)
